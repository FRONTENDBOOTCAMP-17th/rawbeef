    ...
    <div class="max-w-6xl mx-auto px-5 py-8 xl:py-10">
      <div class="grid grid-cols-1 xl:grid-cols-[auto_1fr] gap-8 xl:gap-10">
        ...
        <div class="flex flex-col gap-4 items-center xl:items-start">
          ...
          <ul class="flex flex-wrap gap-3 list-none p-0 m-0 justify-center xl:justify-start">
        ...
        <div class="xl:row-span-2 text-center xl:text-left">
          ...
          <p class="flex flex-wrap gap-x-6 gap-y-2 mb-2 text-xs leading-relaxed text-gray-600 dark:text-gray-500 justify-center xl:justify-start">
          ...
          <ul class="flex flex-wrap gap-x-3.5 gap-y-1 list-none p-0 pt-2 mt-0 border-t border-gray-200 dark:border-gray-800 justify-center xl:justify-start">
        ...
        <div class="flex flex-col gap-2 items-center xl:items-start">
          ...
          <p class="text-gray-500 dark:text-gray-600 text-[11px] xl:text-xs m-0 mt-4">Copyrightⓒ SW cantabile All Rights Reserved.</p>
        </div>
      </div>
    </div>
  </footer>
